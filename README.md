...
Доработка протоколов AANet. Разработка протоколов контроля и управления участниками сети, распределенной системы управления базами данных (РСУБД). Создание возможности коллективно сохранять и обрабатывать данные.
...
Отсутствие анонимности и жесткие правила регистрации позволяют без сторонних сервисов аутетификации работать в сети до 100 участников.
...
Тогда мы выкладываем запрос - поиск уже того, кому нужно сырье для переработки. Возможно, таких организаций у нас даже нет. И тогда мы будем искать того, кому нужно вторсырье на производстве. И уже доворившись с ним, возникает вакантное место для создания бизнеса по пререработке. Останется только предложить и найти исполнителя (у нас есть поставщики и покупатели, только начни работать).
...
Это сеть, объединяющая множество полигонов решающих различные задачи. В основе лежит полигон авторизации и аутентификации, который позволяет всем быть на связи друг с другом, предоставляет возможность найти любого участника сети в сети UCan и связаться с ним.
